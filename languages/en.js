const enMessages = {
  ...
  auth: {
    ...
    alreadyRegisteredAsDifferentType: 'You are already registered using different method.',
  },
  factory: {
  ...
  error: {
    ...
    emailAlreadyConfirmed: 'There is a user with this email address who has already confirmed the email or there is no user with this email address.',
